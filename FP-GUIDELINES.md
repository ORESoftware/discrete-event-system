...
check was introduced: **7,682 findings across 334 files
and 105,520 lines**. CI compares against that budget and fails only when a
...
|---|---:|---|---|---|
| `TS002` | 2606 | warn | immutable values | mutable `let` binding |
| `TS004` | 2117 | warn | pure transformations | in-place array mutation |
| `TS008` | 1715 | warn | effects pushed outward | direct console effect in library code |
| `TS009` | 394 | warn | explicit inputs | ambient impurity (clock / randomness / env) read inside pure code |
| `TS006` | 343 | warn | typed errors | `throw` as control flow |
| `TS005` | 322 | warn | explicit inputs | `any` escapes the type system |
| `XX002` | 94 | warn | explicit outputs | long function body |
| `XX001` | 37 | warn | composition | oversized module |
| `TS003` | 27 | error | explicit state transitions | module-level mutable binding |
| `TS010` | 26 | warn | illegal states excluded by types | non-null assertion (`!`) suppresses a real case |
| `TS001` | 1 | error | immutable values | `var` declaration |

## How to clear the top offenders

### `TS002` — mutable `let` binding

*immutable values* · 2606 occurrences at baseline
...
*pure transformations* · 2117 occurrences at baseline
...
*effects pushed outward* · 1715 occurrences at baseline
...
*explicit inputs* · 394 occurrences at baseline
...
*typed errors* · 343 occurrences at baseline
...
*explicit inputs* · 322 occurrences at baseline
...
*explicit outputs* · 94 occurrences at baseline
...
*composition* · 37 occurrences at baseline
...
*explicit state transitions* · 27 occurrences at baseline
...
*illegal states excluded by types* · 26 occurrences at baseline
