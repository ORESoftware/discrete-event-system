...
export class BinaryDecisionEntity<S, T>
  extends AbstractBidirectionalEntity<S, T>
  implements HasComputedProperties<BinaryDecisionEntity<S, T>>, HasInternalQueue<AbstractMovingEntity<any>> {
  ...
  constructor(id: string, rv: RandomVariable, v: BinaryDecisionEntity<S, T>['opts']) {
    super(id);
